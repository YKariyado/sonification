...
def calculate_and_store_pca_statistics(encoder, x_orig, y_orig, write_dir):
    ...
    # https://math.stackexchange.com/questions/1101022/relation-between-covariance-matrix-and-svd-of-a-given-matrix relationship between covariance, svd and pca
    # variance
...
def train(samples_path='data/interim/samples.npy', lengths_path='data/interim/lengths.npy', epochs_qty=EPOCHS_QTY, learning_rate=LEARNING_RATE):
    ...
    samples_qty = y_samples.shape[0] # shape(102196, 96, 96)
    songs_qty = y_lengths.shape[0] # shape(1202,)
